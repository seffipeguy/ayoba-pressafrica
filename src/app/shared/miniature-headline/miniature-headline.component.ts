...
export class MiniatureHeadlineComponent implements OnInit {
  ...
  constructor(private translate: TranslateService, private alertService: AlertService, private userService: UtilisateurService, private commentService: CommentService, private modalController: ModalController, private headlineService: HeadlineService, private editorService: EditorService) { }
